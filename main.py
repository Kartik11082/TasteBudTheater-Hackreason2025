...
def main():
    ...
    if choice == "1":
        ...
        prompt = f"Generate facts in prolog and give me just the code of facts in prolog(In this format: movie('movie name', ['genre1', 'genre2'], ['actor1', 'actor2'], 'director').) nothing else for this facts about movies given by user in natural language:{question}"
        ...
        question = input("Enter preferences for all users about their favourite actors, directors and genres: ")
        prompt = f"""
